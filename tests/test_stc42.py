...
def test_compensate_temperature_with_sht411(sensor):
    sensor.compensate_temperature_with_sht41()


def test_compensate_humidity_with_sht411(sensor):
    sensor.compensate_humidity_with_sht41()


def test_set_alert_upper_threshold1(sensor):
    sensor.set_alert_upper_threshold(19660)


def test_set_alert_lower_threshold1(sensor):
