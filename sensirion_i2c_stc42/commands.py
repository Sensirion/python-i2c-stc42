...
class PerformForcedRecalibrationTicks(Transfer):
    ...
    Sensors can be permanently compromised if FRC is performed with a parameter ``gas_concentration`` that largely deviates from the actual gas concentrations.
    ...
    def __init__(self, gas_concentration):
        self._gas_concentration = gas_concentration

    def pack(self):
        return self.tx_data.pack([self._gas_concentration])
